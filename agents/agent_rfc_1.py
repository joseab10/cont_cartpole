...
policy = BetaPolicy(state_dim, action_dim=action_dim, act_min=act_min, act_max=act_max,
					a_non_linearity=a_non_linear, a_hidden_layers=a_hid_layers, a_hidden_dim=a_hid_dim,
					b_non_linearity=b_non_linear, b_hidden_layers=b_hid_layers, b_hidden_dim=b_hid_dim,
					ns=ns)
