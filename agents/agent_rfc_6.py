...
policy = MlpPolicy(state_dim, action_dim=action_dim, act_min=act_min, act_max=act_max, non_linearity=pi_non_linear,
				   hidden_layers=pi_hid_layers, hidden_dim=pi_hid_dim, output_non_linearity=None, noise=pi_noise,
